...
pro l1c_viewer_night
  ...
  for iday=1,1 do begin
    ...
    if iday ge 10 and iday lt 10 then sday='0'+string(iday,format='(I2)')
    if iday ge 100 then sday=string(iday,format='(I3)')

    files=file_search('/Users/yiwenzhu/data/GOLD/l1c_NI1/2019/'+sday+'/GOLD_L1C_CHA_NI1_2019_'+sday+'_*_v03_r01_c01.nc',/fully_qualify_path,count=nfiles)
...
;      m=0
        ;map in lon,lat
        i2=image((data(isvalid)),buffer=0,grid_lon(isvalid),grid_lat(isvalid),rgb_table=33,map_projection='Near Side Perspective',center_longitude=-47.5,margin=[0.1,0.02,0.08,0.02],grid_units='degrees',dimensions=[1000,1000],window_title=sut_range,max_value=1000,min_value=0)
        conts=mapcontinents(/countries)
...
;
;        if icounter lt 10 then i2.save, '/Users/YiwenZhu/Desktop/l1c_NI1/2019/gif/'+'/GOLD_L1C_CHA_NI1_2019_'+sday+'_v02_r01_c01.gif',/append,resolution=75
;        if icounter ge 10 then i2.save, '/Users/YiwenZhu/Desktop/l1c_NI1/2019/gif/'+'/GOLD_L1C_CHA_NI1_2019_'+sday+'_v02_r01_c01.gif',/append,resolution=75
;        i2.close
