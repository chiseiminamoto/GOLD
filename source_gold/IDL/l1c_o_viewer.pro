...
;  FILE_MKDIR, '/Users/data/GOLD/l1c/2019/gif_o/'
  ...
  foreach iday,1 do begin
    ...
    files=file_search('/Users/data/GOLD/l1c/2019/'+sday+'/GOLD_L1C_CHA_DAY_2019_'+sday+'_*_v01_r01_c01.nc',/fully_qualify_path,count=nfiles)

    icounter=0

    for ifile=62,62,1 do begin
      ...
      ;map in lon,lat
      i2=image((data(isvalid)),buffer=0,grid_lon(isvalid),grid_lat(isvalid),rgb_table=20,map_projection='Near Side Perspective',center_longitude=-47.5,margin=[0.1,0.02,0.08,0.02],grid_units='degrees',dimensions=[1000,1000],window_title=sut_range,max_value=1e3,min_value=0)
      conts=mapcontinents(/countries)
      c2=colorbar(target=i2,orientation=0,position=[0.1,0.05,0.9,0.07],title='O Radiance',/taper)
...
;        i2.save, '/Users/YiwenZhu/Desktop/l1c/2019/gif_o/'+'/GOLD_L2_O_2019_'+sday+'_v01_r01_c01.gif',/append,/close,resolution=75
;      endif else begin
;        i2.save, '/Users/YiwenZhu/Desktop/l1c/2019/gif_o/'+'/GOLD_L2_O_2019_'+sday+'_v01_r01_c01.gif',/append,resolution=75
;      endelse
;      i2.close
