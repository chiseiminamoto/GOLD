...
pro l2a_viewer_windows

  ;find files for given day
  FILE_MKDIR, 'C:\Users\minamoto\Desktop\2019\gif\'
  for iday=1,1 do begin
    ...
    print,'--------------------',sday,'--------------------'
    files=file_search('C:\Users\minamoto\Desktop\2019\'+sday+'\GOLD_L2_TDISK_2019_'+sday+'_v01_r01_c01.nc',/fully_qualify_path,count=nfiles)
...
;      endfor
    ...
    for iscan=1,dim[3] do begin
        ...
        if iscan mod 2 eq 1 then begin
          ...
          ;i2.save,'/Users/YiwenZhu/Desktop/l2a_all/2019/'+sday+'/GOLD_L2_TDISK_2019_'+sday+'_v01_r01_c01_'+string(iscan/2)+'.png'
          if iscan eq dim[3] then i2.save, 'C:\Users\minamoto\Desktop\2019\gif\GOLD_L2_TDISK_2019_'+sday+'_v01_r01_c01.gif',/append,resolution=75 else i2.save, 'C:\Users\minamoto\Desktop\2019\gif\\GOLD_L2_TDISK_2019_'+sday+'_v01_r01_c01.gif',/append,/close,resolution=75
          i2.close
        endelse
    endfor
