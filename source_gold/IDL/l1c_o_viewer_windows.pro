...
pro brightness,wavelength,radiance,o1356
...
pro l1c_o_viewer_windows
  ...
  foreach iday, 49 do begin
    ...
    files=file_search('C:\Users\minamoto\Desktop\l1c\2019\'+sday+'\GOLD_L1C_CHA_DAY_2019_'+sday+'_*_v01_r01_c01.nc',/fully_qualify_path,count=nfiles)

    icounter=0

    for ifile=32,32,1 do begin
      ...
      brightness,wavelength_1,radiance_1,o1356_1
      ...
      brightness,wavelength_2,radiance_2,o1356_2
      ...
      ;map in lon,lat
      i2=image(alog10((data(isvalid))),buffer=1,grid_lon(isvalid),grid_lat(isvalid),rgb_table=20,map_projection='Near Side Perspective',center_longitude=-47.5,margin=[0.1,0.02,0.08,0.02],grid_units='degrees',dimensions=[1000,1000],window_title=sut_range,max_value=1e3,min_value=0)
      conts=mapcontinents(/countries)
      c2=colorbar(target=i2,orientation=0,position=[0.1,0.05,0.9,0.07],title='LOG10(O Radiance)',/taper)
...
;        i2.save, 'C:\Users\minamoto\Desktop\l1c\2019\gif_o\GOLD_L2_O_2019_'+sday+'_v01_r01_c01.gif',/append,/close,resolution=75
;      endif else begin
;        i2.save, 'C:\Users\minamoto\Desktop\l1c\2019\gif_o\GOLD_L2_O_2019_'+sday+'_v01_r01_c01.gif',/append,resolution=75
;      endelse
;      i2.close
